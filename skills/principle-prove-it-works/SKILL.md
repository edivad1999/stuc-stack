...
The Android UI overlay is P18 (do not claim coverage you did not run).
...
Android UI/device: the **android-verify** skill (Gradle assemble, then `android describe` / `run` / `layout` / `screen`). Do not claim coverage you did not run. (P18)
