...
- `Read` tool calls against any `SKILL.md` file (workspace `docs/**/SKILL.md`, harness delegates under `.cursor/skills/`, `.claude/skills/`, `.codex/skills/`, user-level `~/.cursor/skills/` / `~/.claude/skills/`, or plugin-installed paths)
