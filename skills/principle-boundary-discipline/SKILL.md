...
The Android app/data overlay below is P2.
...
- **Android app/data (P2).** App/UI modules consume domain models and interfaces. They do not import data-layer DTOs or entities. Data maps and implements repositories. Do not add new app→data model imports.
