...
Requires chrisbanes/skills, android/skills, and `android` on PATH. Those trees are not in this git repo. Remaining enable steps: `.agents/stuc-stack-intake/design/install-status.md`.
