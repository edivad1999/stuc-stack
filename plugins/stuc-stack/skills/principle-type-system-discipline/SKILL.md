...
Kotlin syntax is chrisbanes `kotlin-types-value-class` (load via **kotlin-best-practices** / **using-chrisbanes-skills**). App/data, JSON stack, and handler-name overlays live in **kotlin-best-practices**, not here.
