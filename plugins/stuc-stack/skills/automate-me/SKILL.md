...
The **stuc-mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as stuc-mode's.
...
- The **stuc-mode** skill: example of the output shape.
