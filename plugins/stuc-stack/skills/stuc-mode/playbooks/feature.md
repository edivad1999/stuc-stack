...
2. `architect` for parallel design exploration. Skipping stays as `architect skipped: <reason>`; do not fold the design decision silently into implementation. Copy-the-last-screen / smallest-diff is a valid skip reason in this stack.
